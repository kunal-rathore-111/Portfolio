...
import { GithubPage } from "./Github.jsx";
...
export const MainComp = () => {
    ...
    return <main className={`w-full flex flex-col items-center transition-all duration-1000 pb-20 px-4 lg:pt-0 lg:pb-0 lg:px-8 md:pt-0 md:pb-0 md:px-10 ${toggle ? "lg:pl-[10vw]" : "lg:pl-[13vw]"}`}>
        ...
        <div className="w-full max-w-6xl py-10" ref={MoreRef} data-section="Achievements"><AchievementsPage /></div>
        <div className="w-full max-w-6xl py-10" data-section="Reads"><ReadsPage /></div>
        <div className="w-full max-w-6xl py-10" data-section="Github"><GithubPage /></div>
        <Footer />
    </main>
}