    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 203" className="size-6" fill="none">
            <defs>
                ...
                <path id="logosZod1" fill="#000" d="M200.42 0H53.63L0 53.355l121.76 146.624l9.714-10.9L252 53.857L200.42 0Zm-5.362 12.562l39.84 41.6l-112.8 126.558L17 54.162l41.815-41.6h136.243Z" />
            </defs>
            <g>
